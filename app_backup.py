...
st.markdown("""
    ...
    /* Espaciado entre columnas de tarjetas */
...
def generate_user_names(user_ids):
    """
    Genera nombres de usuario basados en los IDs
    """
    nombres = [
        ...
        for j, col in enumerate(cols):
            if i + j < len(recommendations):
                ...
                with col:
                    ...
                    ">
                        <div>
                            <h4 style="margin: 0; color: white; font-size: 1.1rem;">#{i+j+1} {rec['product_name']}</h4>
...
def main():
    ...
    with st.sidebar:
        ...
        # Crear opciones con formato "Nombre (ID: #)"
        ...
        selected_user = st.selectbox(
            ...
            index=0,
            help="Selecciona tu usuario para obtener recomendaciones personalizadas"
        )
    ...
    # Mostrar información del usuario seleccionado arriba de las pestañas
    st.markdown(f"""
    <div style="
        ...
        box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);
    ">
        <h3 style="color: white; margin: 0; font-size: 1.3rem;">👤 Usuario Activo</h3>
        <h2 style="color: white; margin: 0.5rem 0 0 0; font-size: 2rem;">{user_name}</h2>
        <p style="color: rgba(255, 255, 255, 0.8); margin: 0.3rem 0 0 0; font-size: 1.1rem;">ID: {user_id}</p>
    </div>
    """, unsafe_allow_html=True)
